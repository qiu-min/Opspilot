...
export type TurnStreamEvent =
  ...
  | (TurnStreamEventBase & { type: "tool_queued"; callId: string; name: string; batchId?: string })
  | (TurnStreamEventBase & { type: "tool_started"; callId: string; name: string })
  | (TurnStreamEventBase & { type: "tool_completed"; callId: string; name: string; isError: boolean })
