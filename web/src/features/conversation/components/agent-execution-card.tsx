...
import type { AgentExecutionBlock, ConversationResponseBlockStatus } from "../types";
...
function StepIcon({ status }: { status: ConversationResponseBlockStatus }) {
  if (status === "completed") {
...
function getExecutionStatus(execution: AgentExecutionBlock): ConversationResponseBlockStatus {
...
function getStatusLabel(status: ConversationResponseBlockStatus): string {
...
function getStatusTone(status: ConversationResponseBlockStatus) {
